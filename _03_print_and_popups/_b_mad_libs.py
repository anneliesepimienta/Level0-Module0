...
if __name__ == '__main__':
    ...
    adj = simpledialog.askstring(title = "cat", prompt  = "enter an adj")

    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title = "cat", prompt = "enter a liquid")
    # Get the player to enter a body part
    body_part = simpledialog.askstring(title = "cat", prompt = "eneter a body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring(title = "cat", prompt = "enter a verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title = "cat", prompt = "enter a place")
