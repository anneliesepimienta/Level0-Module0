...
if __name__ == '__main__':
    ...
    # Make a new turtle
    stonefur=turtle.Turtle()
    # Make the turtle shape 'turtle', .shape('turtle')
    stonefur.shape("turtle")
